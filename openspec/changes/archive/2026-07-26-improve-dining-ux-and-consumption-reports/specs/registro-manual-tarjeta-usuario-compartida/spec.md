...
mostrar de forma consistente los datos del estudiante (identificación, nombre, carrera y estado) y
...
- **THEN** presenta identificación, nombre, carrera y estado con el mismo formato en todas las pantallas que la usan
